...
class FSDPLlamaModel(LlamaPreTrainedModel):
    """
    ...
    def __init__(self, config: LlamaConfig):
        ...
        fsdp_wrap = lambda m: FSDP(m, compute_dtype=torch.bfloat16, shard_param_on_dim_0=True, pin_layout_in_collective_ops=True, disable_reshard_on_root=False, reshard_after_forward=True)
        # grad_ckpt_wrap = checkpoint_module
        grad_ckpt_wrap = lambda x:x 
        ...
        print("FSDP wrapping decoder blocks.")
        layers = []
