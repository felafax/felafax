...
@dataclass
class JaisonDataConfig(DatasetConfig):
...
@dataclass
class JaisonTrainerConfig(TrainerConfig):
...
@dataclass
class JaisonCheckpointerConfig(CheckpointerConfig):
...
class PipelineConfig:
    ...
    data_config: JaisonDataConfig = field(default_factory=JaisonDataConfig)
    trainer_config: JaisonTrainerConfig = field(
        default_factory=JaisonTrainerConfig
    )
    checkpointer_config: JaisonCheckpointerConfig = field(
        default_factory=JaisonCheckpointerConfig
    )
